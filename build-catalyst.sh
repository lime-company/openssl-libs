...
#
###########################################################################
#    Change target architectures and OpenSSL version in external          #
#       >>  openssl-version.sh  <<   configuration script                 #
#    The configuration is common for both iOS & Android platforms         #
#                                                                         #
...
mkdir -p "${CURRENTPATH}/macCatalyst/lib"
mkdir -p "${CURRENTPATH}/macCatalyst/include"
...
lipo -create \
	${CURRENTPATH}/bin/macCatalyst${SDKVERSION}-x86_64.sdk/lib/libcrypto.a \
	-output ${CURRENTPATH}/macCatalyst/lib/libcrypto.a

# remove headers & copy new one
rm -rf "${CURRENTPATH}/macCatalyst/include/"
mkdir -p "${CURRENTPATH}/macCatalyst/include"
cp -R ${CURRENTPATH}/bin/macCatalyst${SDKVERSION}-x86_64.sdk/include/openssl ${CURRENTPATH}/macCatalyst/include/
echo "Building done."
echo "Cleaning up..."
